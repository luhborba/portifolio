...
SideBar = st.sidebar.selectbox('Escolha o Projeto: ', ['Página Incial','Análise Sec. de Saúde de João Pessoas(Power BI)','Projeto Unicórnios','Projeto Mercado Financeiro (MAGALU)','Projeto PS4','Projeto NBA','Projeto Renda Per Capita','Outros'])
if SideBar == 'Página Incial':
    pi.Porti()
    
elif SideBar == 'Análise Sec. de Saúde de João Pessoas(Power BI)':
